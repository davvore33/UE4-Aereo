...
unrealRootPath=/home/matteo/Documenti/UnrealEngineTest/UnrealEngine
AereoRootPath=/home/matteo/Documenti/Unreal Projects/Aereo

gameProjectFile=/home/matteo/Documenti/Unreal Projects/Aereo/Aereo.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(AereoSource.pri)
include(AereoHeader.pri)
include(AereoConfig.pri)
include(AereoIncludes.pri)
include(AereoDefines.pri)
...
Aereo-Linux-Debug.commands = $$build Aereo Linux Debug  -project="\"$$gameProjectFile\"" $$args
Aereo-Linux-DebugGame.commands = $$build Aereo Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
Aereo-Linux-Shipping.commands = $$build Aereo Linux Shipping  -project="\"$$gameProjectFile\"" $$args
Aereo-Linux-Test.commands = $$build Aereo Linux Test  -project="\"$$gameProjectFile\"" $$args
Aereo.commands = $$build Aereo Linux Development  -project="\"$$gameProjectFile\"" $$args

AereoEditor-Linux-Debug.commands = $$build AereoEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
AereoEditor-Linux-DebugGame.commands = $$build AereoEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
AereoEditor-Linux-Shipping.commands = $$build AereoEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
AereoEditor-Linux-Test.commands = $$build AereoEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
AereoEditor.commands = $$build AereoEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	Aereo-Linux-Debug \
	Aereo-Linux-DebugGame \
	Aereo-Linux-Shipping \
	Aereo-Linux-Test \
	Aereo \
	AereoEditor-Linux-Debug \
	AereoEditor-Linux-DebugGame \
	AereoEditor-Linux-Shipping \
	AereoEditor-Linux-Test \
	AereoEditor \
